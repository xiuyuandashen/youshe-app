  ...
  <div>
    ...
    <van-row type="flex" justify="center" style="margin-top: 5vh">
      ...
      <van-col span="22" style="text-align: center"
        ><img src="@/assets/logo.png" style="width: 10vh" alt="login"
      /></van-col>
      <van-col span="1">&nbsp</van-col>
    </van-row>
...
export default {
  ...
  methods: {
    ...
    login() {
      if (
        this.my.name == undefined ||
        this.my.password == undefined ||
        this.my.captchaCode == undefined
      ) {
        Toast.fail("请填写表单！");
        return;
      }
